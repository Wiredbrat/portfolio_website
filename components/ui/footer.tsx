...
export default function Footer() {
  return (
    <div className="border-t my-3 py-4">
        <div className="max-w-5xl grid md:grid-cols-3 w-[90%] mx-auto gap-5">
          <div>
            <div className="flex gap-4 justify-center md:justify-start">
              <a href="https://www.linkedin.com/in/atul-verma-wired" className=" hover:opacity-100 opacity-70 duration-150">
              ...
              <a href="https://github.com/wiredbrat" className=" hover:opacity-100 opacity-70 duration-150">
              ...
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=vermaatul291002@gmail.com&su=Hey%20Atul!" className=" hover:opacity-100 opacity-70 duration-150">
          ...
          <div>
            <div className="flex flex-col items-center space-y-6 montserrat opacity-70"> 
              <div className="grid grid-cols-1 gap-3 w-full max-w-xs py-6"> 
                ...
                <div className="flex items-center justify-center lg:justify-normal space-x-3"> 
                  <span className="text-white text-sm"> Styled with </span> 
                  <SiTailwindcss className="h-5 w-5 object-contain filter brightness-0 invert opacity-80" /> 
                  <span className="text-white text-sm"> TailwindCSS </span> 
                </div>
                <div className="flex items-center justify-center lg:justify-normal space-x-3"> 
                  <span className="text-white text-sm"> Deployed on </span> 
                  <SiVercel className="h-5 w-5 object-contain filter brightness-0 invert opacity-80" /> 
